define({ "api": [
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i https://testapi.valitor.is:444/PaymentManager/DoPayment/24e7facd-cf63-47b5-9b81-8e94cc68d75",
        "type": "json"
      }
    ],
    "success": {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i https://testapi.valitor.is:444/PaymentManager/InitiatePaymentRequest/dda616b7-6ecf-46c2-aa4c-d8c97fcfe2f9/10/840/30",
        "type": "json"
      }
    ],
    "success": {
